...
export interface DbConnected<EntityT, QueryT, UpdatableFields> {
    create: (initData: any, ...args: any[]) => Promise<EntityT> | Promise<EntityT[]> | Promise<boolean>;
    del: (query: QueryT, ...args: any[]) => Promise<EntityT> | Promise<EntityT[]> | Promise<boolean>;
    find: QueryableFunc<EntityT, QueryT>;
    update(updateData: UpdatableFields, query: QueryT, ...args: any[]): Promise<EntityT> | Promise<EntityT[]> | Promise<boolean>;
}
export interface Creatable<EntityT> {
     ...
     */
    create(arg?: any): Promise<EntityT> | Promise<boolean>;
}
...
export interface QueryableFunc<EntityT, QueryT> {
    (query?: QueryT, ...args: any[]): Promise<EntityT> | Promise<EntityT[]>;
}
